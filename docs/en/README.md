# Shibuhouse COVID-19 Task Force website

![](https://github.com/MasujimaRyohei/covid19-shibuhouse/workflows/production%20deploy/badge.svg)

[![Shibuhouse COVID-19 Task Force website](https://user-images.githubusercontent.com/17163541/78853699-7b26b100-7a5a-11ea-9729-6476afff83d7.jpg)](https://stopcovid19-shibuhouse.netlify.com/)
...
and then the production site (https://stopcovid19-shibuhouse.netlify.com/) will be also updated.

When `staging` branch is updated, the HTML files will be automatically built onto `gh-pages` branch,
and then the staging site (https://stg-stopcovid19-shibuhouse.netlify.com/) will be also updated.

When `development` branch is updated, the HTML files will be automatically built onto `dev-pages` branch,
and then the development site (https://dev-stopcovid19-shibuhouse.netlify.com/) will be also updated.
...
| ---- | -------- | ---- | ---- |
| Development | development | https://dev-stopcovid19-shibuhouse.netlify.com/ | base branch. Basically send a Pull Request here |
...
| Staging | staging | https://stg-stopcovid19-shibuhouse.netlify.com/ | For final confirmation before production. Non-admin pull requests are prohibited |
Production | master | https://stopcovid19-shibuhouse.netlify.com/ | Pull Requests other than Administrators are prohibited |

#### Branch used by the system
| Purpose | Branch | Confirmation URL | Remarks |
| ---- | -------- | ---- | ---- |
| Production site HTML | production | https://stopcovid19-shibuhouse.netlify.com/ | Location where statically built HTML is located |
| Staging site HTML | gh-pages | https://stg-stopcovid19-shibuhouse.netlify.com/ | Where to find statically built HTML |
