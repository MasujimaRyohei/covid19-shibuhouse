...
[![渋家 新型冠狀病毒疫情中心](https://user-images.githubusercontent.com/17163541/78853699-7b26b100-7a5a-11ea-9729-6476afff83d7.jpg)](https://stopcovid19-shibuhouse.netlify.com/)
...
當 `master` 分支被更新時，HTML 檔案將會在 `production` 分支中被 build 起來，然後正式版網站 https://stopcovid19-shibuhouse.netlify.com/ 會被更新。

當 `staging` 分支被更新時，HTML 檔案將會在 `gh-pages` 分支中被 build 起來，然後 Staging 版網站 https://stg-stopcovid19-shibuhouse.netlify.com/ 會被更新。

當 `development` 分支被更新時，HTML 檔案將會在 `dev-pages` 分支中被 build 起來，然後開發版網站 https://dev-stopcovid19-shibuhouse.netlify.com/ 會被更新。
...
| 目的 | 分支 | 預覽用 URL | 備註 |
| ---- | -------- | ---- | ---- |
| 開發 | development | https://dev-stopcovid19-shibuhouse.netlify.com/ | 基本上請推送 Pull Request 到這裡 |
| 緊急修復 | dev-hotfix | 無 | 對於正式版的緊急修復。 在管理員的要求下使用。 |
| 正式版預覽 | staging | https://stg-stopcovid19-shibuhouse.netlify.com/ | 對於正式版釋出前的最終確認，禁止管理員以外的人推送 Pull Request。 |
| 正式版 | master | https://stopcovid19-shibuhouse.netlify.com/ | 禁止管理員以外的人推送 Pull Request |
#### 系統所使用的分支
| 目的 | 分支 | 預覽用 URL | 備註 |
| ---- | -------- | ---- | ---- |
| 正式網站 HTML | production | https://stopcovid19-shibuhouse.netlify.com/ | 生成靜態網站 HTML 的位置 |
| 正式版預覽 HTML | gh-pages | https://stg-stopcovid19-shibuhouse.netlify.com/ | 生成靜態網站 HTML 的位置 |
