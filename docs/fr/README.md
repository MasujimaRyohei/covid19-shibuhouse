...
[![Tokyo COVID-19 Task Force website](https://user-images.githubusercontent.com/17163541/78853699-7b26b100-7a5a-11ea-9729-6476afff83d7.jpg)](https://stopcovid19-shibuhouse.netlify.com/)
...
et le site production (https://stopcovid19-shibuhouse.netlify.com/) est aussi mis-à-jour.

Quand la branche `staging` est mise-à-jour, les fichiers HTML sont automatiquement construits vers la branche `gh-pages`,
et le site staging (https://stg-stopcovid19-shibuhouse.netlify.com/) est aussi mis-à-jour.

Quand la branche `development` est mise-à-jour, les fichiers HTML sont automatiquement construits vers la branche `dev-page`,
et le site development (https://dev-stopcovid19-shibuhouse.netlify.com/) est aussi mis-à-jour.
...
| ---- | -------- | ---- | ---- |
| Development | development | https://dev-stopcovid19-shibuhouse.netlify.com/ | Branche de base. Faites votre Pull Request ici. |
...
| Staging | staging | https://stg-stopcovid19-shibuhouse.netlify.com/ | Pour confirmation avant production. Pull request d'utilisateurs non-admin sont defendues. |
Production | master | https://stopcovid19-shibuhouse.netlify.com/ | Pull request d'utilisateurs non-admin sont defendues. |

#### Branches utilisees par le systeme

| But | Branche | URL | Notes |
| ---- | -------- | ---- | ---- |
| Production site HTML | production | https://stopcovid19-shibuhouse.netlify.com/ | Place ou les pages HTML statiques sont stockees. |
| Staging site HTML | gh-pages | https://stg-stopcovid19-shibuhouse.netlify.com/ | Ou trouver l'HTML statiquement construit. |
