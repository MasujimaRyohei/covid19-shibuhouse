...
และ เว็บไซต์ (https://stopcovid19-shibuhouse.netlify.com/) จะได้รับการอัพเดท

ถ้า 'staging' ได้รับการแก้ไขหรือปรับปรุง HTML จะถูกสร้างและส่งไปยัง 'gh-pages' โดยอัตโนมัติ
และ เว็บไซต์ (https://stg-stopcovid19-shibuhouse.netlify.com/) จะได้รับการอัพเดท

ถ้า 'development' ได้รับการแก้ไขหรือปรับปรุง HTML จะถูกสร้างและส่งไปยัง 'dev-pages' โดยอัตโนมัติ
และ เว็บไซต์ (https://dev-stopcovid19-shibuhouse.netlify.com/) จะได้รับการอัพเดท
...
| ---- | -------- | ---- | ---- |
| Development | development | http://dev-stopcovid19-shibuhouse.netlify.com/ | branch หลัก ใช้ในการรับ pull request |
| Hotfix branch | dev-hotfix | None | Branch สำหรับ hotfix ของ production - ใช้ในกรณีที่ admin อนุญาตแล้วเท่านั้น |
| Staging | staging | https://stg-stopcovid19-shibuhouse.netlify.com/ | ใช้สำหรับ staging ทดสอบตัวปรับปรุง ก่อน deploy ลง production - ห้ามสร้าง pull request ยกเว้นจาก admin เอง |
| Production | master | https://stopcovid19-shibuhouse.netlify.com/ | ห้ามสร้าง pull request ยกเว้นจาก admin เอง |

#### branch ที่ถูกใช้โดยระบบ
| จุดประสงค์ | branch | URL | หมายเหตุ |
| ---- | -------- | ---- | ---- |
| Production site HTML | production | https://stopcovid19-shibuhouse.netlify.com/ | HTML สำหรับ production |
| Staging site HTML | gh-pages | https://stg-stopcovid19-shibuhouse.netlify.com/ | HTML สำหรับ staging |
