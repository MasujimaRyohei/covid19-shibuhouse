<template>
  <div class="About">
    ...
    <StaticCard>
      ...
      {{
        $t(
          '渋家による公式情報と客観的な数値をわかりやすく伝えることで、渋家にお住まいの方や、渋家と関わりがある方、渋家に住んでみたい方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </StaticCard>
    <StaticCard>
    ...
    <StaticCard>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、渋家は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
